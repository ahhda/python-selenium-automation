...
#test = "2013A7PS100"
amount = "220"
book = xlrd.open_workbook('C:\Users\Anuj\Desktop\csatshirt.xlsx')
...
#driver.find_element_by_xpath(xpaths['addnext']).click()
#driver.find_element_by_xpath(xpaths['finish']).click()
